<?php
	...
	$sql="select senderName, RecipientName, ChatID, Subject, Status from inbox where senderName = '". $_SESSION['admin_username']. "' or RecipientName= '".$_SESSION['admin_username']."' order by ChatID desc";
