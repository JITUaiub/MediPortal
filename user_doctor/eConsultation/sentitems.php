<?php
    ...
    $sql="select senderName, RecipientName, ChatID, Subject, Status from inbox where senderName = '". $_SESSION['doctor_username']. "' or RecipientName= '".$_SESSION['doctor_username']."' order by ChatID desc";
