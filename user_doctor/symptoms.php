...
<head><title>Symptoms</title></head>
                                ...
                                <h1>Disease Symptoms </h1>
                                   <div>
                                    <fieldset>
                                        ...
                                        <fieldset>
                                            <legend><b>Check Symptoms</b></legend>
                                            <table border="0">
                                                <tr>
                                                    <td width="50%" align="center">
                                                        <label><b>Patient Name:</b>Bob Marley</label>
                                                    </td>
                                                    <td>
                                                        <table>
                                                            <tr>
                                            ...
                                            <table border="0">
                                                <tr>
                                                    <td width="50%" align="center">
                                                        <label><b>Patient Name:</b>Mr.XYZ</label>
                                                    </td>
                                                    <td>
                                                        <table>
                                                            <tr>
                                                                <td width="15%">
                                                                    <label><b>Symptoms:</b></label>
                                                                    <p> 5.Loss of appetite</br>
                                                6.Irritability</br>
                                                7.Dehydration</br>
                                                8.General weakness</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
